                        ...
                        <div className=' ps-xl-4'>
                            ...
                            <div className="d-flex align-items-center mt-3">
                                ...
                                <div className='d-flex gap-2 ms-3'>
                                    <div className="colors_box_border d-flex align-items-center justify-content-center"> <span className='colors_box1'></span></div>
                                    <div className="colors_box_border d-flex align-items-center justify-content-center"> <span className='colors_box2'></span></div>
                                    <div className="colors_box_border d-flex align-items-center justify-content-center"> <span className='colors_box3'></span></div>
                                    <div className="colors_box_border d-flex align-items-center justify-content-center"> <span className='colors_box4'></span></div>
                                </div>
                            </div>
